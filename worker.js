...
const ONTO_CLASSES = {
  ...
  'COV': {
    classes: ['cov:Organization (Organizzazione)', 'cov:PublicOrganization (Organizzazione pubblica)', 'cov:Organization (Impresa)', 'cov:ActivityType (Tipo attività)', 'cov:ContactPoint (Punto di contatto)', 'cov:Email (Email)', 'cov:Telephone (Telefono)'],
