...
export default {
  async fetch(request, env, ctx) {
    ...
    if (reqUrl.pathname === '/health') {
      return new Response(JSON.stringify({ status: 'ok', version: 'v2026.04.14.04' }), {
